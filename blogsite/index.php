...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href=".html">Navie String Algorithm</a></h4>
...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">Kmeans Algorithm</a></h4>
		    <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href=".html">longest common subsequence Algo</a></h4>
		    <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
		    		<a href=".html"><i class="fa fa-folder-open-o"></i>Details</a>
		    	</li>
...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">Logistic Regression Algorithm</a></h4>
		    <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
		    		<a href="#.html"><i class="fa fa-folder-open-o"></i>Details</a>
		    	</li>
